...
const parameterNames: Record<string, string[]> = {
  ...
  download_and_install_crash_mod_fix: ['gamePath', 'modName', 'affectedVersions', 'fixedVersion', 'url', 'sha256', 'onEvent'],
  runtime_platform: [],
  get_loenn_state: [],
  download_and_install_loenn: ['version', 'url', 'packageType', 'fileName', 'executable', 'sha256', 'onEvent'],
  start_loenn: [],
