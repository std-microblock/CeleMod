...
export const RecommendMaps = () => {
    ...
    const InstallButton = ({
        ...
        const [state, setState] = useState(installed ? "已安装" : "安装")
        ...
        const startDownload = () => {
            ...
            callRemote('get_mod_update', name, (data) => {
                if (!!data) {
                    ...
                    ctx.download.downloadMod(name, parseInt(gbFileId) === -1 ? url : gbFileId, {
        ...
        return <Button onClick={() => startDownload()}>
            {state}
        </Button>
    }
            ...
            <div className="collabs" onWheel={horizontalScrollMouseWheelHandler}>
                <div className="collab" style={{
                    ...
                    <div className="intro">
                        ...
                        <div className="subtitle">
                            <b>别名</b> 酱游 / Strawberry Jam
                        </div>

                        <div className="desc">
                            <p>最为经典的地图集，于 2023 年推出</p>
                            <p>质量极高，每张图都有自己的特色；背景音乐与环境制作精良</p>
                            <p>分为五个难度（即酱一至酱五），从刚入门的新手到千小时的老鸟都可以打~</p>
                        </div>
                        <div className="info">
                            <span className="inf">
                                <Icon name="download" />
                    ...
                    <div className="oper">
                        <InstallButton name="StrawberryJam2021" url='https://celeste.weg.fan/api/v2/download/mods/StrawberryJam2021' />
                    </div>
                </div>
                ...
                <div className="collab" style={{
                    ...
                    <div className="intro">
                        ...
                        <div className="subtitle">
                            <b>别名</b> 2024CNY / Gallery Collab
                        </div>
                        <div className="desc">
                            <p>包含超过20张地图和一个极其漂亮的大厅</p>
                            <p>涵盖酱一至酱五所有难度，数种与众不同的新机制等待玩家去探索</p>
                            <p>国人原创图，国风浓厚，难度偏高，美术优美，音乐好听，非常推荐安装尝试</p>
                        </div>
                        <div className="info">
                            <span className="inf">
                                <Icon name="download" />
                    ...
                    <div className="oper">
                        <InstallButton name="ChineseNewYear2024Collab" url='https://celeste.weg.fan/api/v2/download/mods/ChineseNewYear2024Collab' />
                    </div>
                </div>
                ...
                <div className="collab" style={{
                    ...
                    <div className="intro">
                        ...
                        <div className="subtitle">
                            <b>别名</b> Spring Collab 2020
                        </div>
                        <div className="desc">
                            <p>包含80+地图，5个章节，数十种新机制</p>
                            <p>Spring Collab 有 5 个大厅供您探索，里面装满了社区制作的地图。地图的难度从早期的原版内容到一些现存最难的 Celeste 地图均有覆盖</p>
                            <p>老牌地图，比草莓酱简单，还行</p>
                        </div>
                        <div className="info">
                            <span className="inf">
                    ...
                    <div className="oper">
                        <InstallButton name="SpringCollab2020" url='https://celeste.weg.fan/api/v2/download/mods/SpringCollab2020' />
                    </div>
                </div>
                ...
                <div className="collab" style={{
                    ...
                    <div className="intro">
                        ...
                        <div className="subtitle">
                            <b>别名</b> the road less travelled
                        </div>
                        <div className="desc">
                            <p>单图，美术和音乐都很好</p>
                            <p>MB 自己很喜欢的一张图，有 20-30 面，感觉很平和（中文名是自己翻译的）</p>
                            <p>A 面难度在 5A - 6A，B面/C面有一些技巧，难度在 7B 的样子</p>
                        </div>
                        <div className="info">
                            <span className="inf">
                                <Icon name="download" />
                    ...
                    <div className="oper">
                        <InstallButton name="the road less travelled" url='https://celeste.weg.fan/api/v2/download/mods/the%20road%20less%20travelled' />
                    </div>
                </div>
            </div>
