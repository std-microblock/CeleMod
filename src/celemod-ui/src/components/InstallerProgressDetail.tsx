...
export const InstallerProgressDetail = ({
  status,
}: {
  status: string | null;
}) => {
  ...
  return (
    <div
      className="android-installer-progress"
      role="status"
      aria-live="polite"
    >
      <strong>
        {progress.stage}/{progress.total} · {stages[progress.stage - 1]}
      </strong>
      <span>
        {_i18n.t("安装阶段耗时")} {formatInstallerElapsed(progress.elapsed)}
      </span>
